// Permutation: locale:en_US; qx.client:"gecko"; qx.debug:"on"; qx.dynlocale:"off"; qx.globalErrorHandling:"off"; qx.theme:"apiviewer.Theme"; qx.version:1.0 (2c2aa01847dccbca535e11b2587e8d2f)
...
//   - packages:
//       qx.Class.define, 1x
//       qx.dom.Node.getName, 2x
//       qx.dom.Node.isElement, 1x
...
get:function(k,j){var e=qx.bom.element.Style.get(k,"clip",j,false),c,d,h,g,b,a,i,f;
if(typeof e==="string"&&e!=="auto"&&e!==""){e=qx.lang.String.trim(e);
if(/\((.*)\)/.test(e)){i=RegExp.$1;
if(/,/.test(i))f=i.split(",");
else f=i.split(" ");
...
reset:function(a){a.style.clip="rect(auto, auto, auto, auto)"}}});
...
//       undefined, 3x
//   - packages:
//       document.createEvent, 2x
//       document.createEventObject, 1x
//       qx.Class.define, 1x
...
//   - packages:
//       qx.Class.define, 1x
//       qx.bom.Event.addNativeListener, 5x
//       qx.bom.Event.getTarget, 5x
//       qx.bom.Event.preventDefault, 2x
//       qx.bom.Event.removeNativeListener, 5x
...
//       qx.bom.Event, 4x
//       qx.bom.Event.addNativeListener, 1x
//       qx.bom.Event.getTarget, 2x
//       qx.bom.Event.removeNativeListener, 1x
//       qx.bom.Event.supportsEvent, 2x
...
var a=this.__qOaV1,b=qx.bom.Event.supportsEvent(a,"mousewheel")?"mousewheel":"DOMMouseScroll";
qx.bom.Event.addNativeListener(a,b,this.__bP0kNk)},
...
_stopWheelObserver:function(){var a=this.__qOaV1,b=qx.bom.Event.supportsEvent(a,"mousewheel")?"mousewheel":"DOMMouseScroll";
qx.bom.Event.removeNativeListener(a,b,this.__bP0kNk)},
...
if(i==="bottom"||i==="right"){j=u-1,m=-1,o=-1}else{j=0,m=u,o=1}if(i=="top"||i=="bottom"){if(w){r=0,a=j;
for(;
a!=m;
...
if(q>1){y=(q-1)*n;
h-=y}if(l){c=l.getSizeHint(),x=Math.max(c.minWidth,Math.min(h,c.maxWidth));
h-=x}f=w&&h>0?Math.round(h/2):0;
for(a=j;
a!=m;
a+=o){d=k[a];
c=d.getSizeHint();
e=Math.min(c.maxHeight,Math.max(p,c.minHeight));
b=d===l?x:c.width;
t="middle";
i=="top-left"?t="top":i=="bottom-left"&&(t="bottom");
g=v.computeVerticalAlignOffset(t,c.height,p);
d.renderLayout(f,g,b,e);
b>0&&(f+=b+n)}}},
...
a&&a.add(this)},
_applyValue:function(a,b){a?this.addState("checked"):this.removeState("checked")},
_onExecute:function(a){this.toggleValue()},
